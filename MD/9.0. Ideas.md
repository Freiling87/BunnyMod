...
- Gang Land
  - Adds ~5 of each gang roaming the district.
    - Maybe scale this to Level Size mutators.
- Green Arcology
  - All default floors changed to Grass
  - Bushes and Trees generate in all districts
- Nanobot HMO 
  - Everyone permanently slowly regenerates health
- Mob Town
  - Mafia spawn on all levels
    - May be extremely easy, just set LevelData.levelFeatures.Contains("Mafia") to true
- No NPC Tethers
- Return to Shrunke
