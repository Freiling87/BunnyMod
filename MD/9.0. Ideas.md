...
#
# Future Release Slate (Not the stuff I'm working on now)
<details>
<summary> Expand/Collapse </summary>

## Good & Evil
- Blessed & Infernal Strikes
- Priest NPC & PC
- All Undead-related and Holy-related features
## Overhauls
- Police State
- FALGSC
- AnCapistan
...
- Godslayer
  - Desecrate all Altars and defeat their champions
- Holy Champion
  - Defense quests for Altars
- Karen 
...
- Slave
  ...
  - More demanding version of Musician, with beatings or instant death as the punishment.
- Undead Slayer
  - Kill all Undead. 
...
### Musician
- Bonus to spin records (Not much, I know)
- Occasional fans like with Bouncer
- Special: Reusable BoomBox
...
- Trait: Exorcist
  - Evil undead
    ...
    - Bonus for kills
    - Hostile on sight
    - Take damage when nearby
  - Good undead (Just ghosts for now)
    - Interact to set to Rest
  - Shapeshifter
...
- Should also include a general code of conduct trait
