...
- Spelunky Dory
  - Add Boulders
  - Maybe make a table of these themes with features
- Eagle Eyes
  - NPC activity range needs to be increased
  - Reduce UI scale
- Domineering2
  - Not found in Conflict for Unpleasant
- Mook Masher
  - E_Goon, not a name
- All social traits aren't triggering
...
All traits in categories marked with an asterisk (*) are mutually exclusive.
...
|Spelunky Dory                  |- All randomized walls will spawn as Cave Wall.<br>- Neutral floors will spawn as Cave Floor.

### Floor Tiles *

*N.B.: If a chunk uses non-neutral floors, they will not be affected by these mutators.*

|Name                           |Effect|
|:------------------------------|:-----|
|Arcology Ecology               |- Neutral floors will spawn as Grass.<br>- Natural features spawn in all districts.<br>- Pollution features will not spawn.
|Sunken City                    |- Neutral floors will spawn as Water.
|Transit Experiment             |- Neutral floors will spawn as Ice.
