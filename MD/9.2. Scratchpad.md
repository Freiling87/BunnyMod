...
- Make an Owner come and tell the winner they're cut off, but give them a free drink
  - This would be good when you do a full gambling update.
- Jackpot
...
- Model this one on Penetrating Bullets. There should be a conditional bullet removal portion based on that.
## Spelunky Dory
- Cave outcroppings
