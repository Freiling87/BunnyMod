...
- GenEric:
  - @Matt Dabunski  how does the Ammo Processor work ammowise cus im editing the wiki and it seems a little bit like tier based?
...
[Message: Bunny Mod]    name: Tree (2925)
[Message: Bunny Mod] BulletHitbox_OnTriggerEnter2D
[Message: Bunny Mod]    name: TreeWall
...
Stack trace:
BunnyMod.Content.BMCombat.BulletHitbox_OnTriggerEnter2D (UnityEngine.Collider2D other, BulletHitbox __instance) (at <a537958cbe2642b88e5d14fbe86257ab>:0)
...
- Hydrant
    ...
    [Error  : Unity Log] NullReferenceException: Object reference not set to an instance of an object
    Stack trace:
    BunnyMod.Content.BMCombat.BulletHitbox_OnTriggerEnter2D (UnityEngine.Collider2D other, BulletHitbox __instance) (at <6ce14eaebc8e43abb3384b13c101d68b>:0)
    BulletHitbox.OnTriggerEnter2D (UnityEngine.Collider2D other) (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
    ```
...
- if a silenced weapon runs out and the next one to be selected is too loud, it'll keep clicking the trigger on the quiet gun because it can't switch. Instead it should skip the loud one and switch to a quiet weapon even if out of order.
  - Here:
  ```
    [Message: Bunny Mod] InvDatabase_Chooseweapon
    [Message: Bunny Mod] DoesPlayerHaveTraitFromList
    [Message: Bunny Mod]    Trait found
    [Message: Bunny Mod]    item: Revolver
    [Message: Bunny Mod]    Loud: True
    [Message: Bunny Mod]    Contains: Silencer
    [Message: Bunny Mod]    item: Money
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: KillProfiterAmmo
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: Pistol
    [Message: Bunny Mod]    Loud: True
    [Message: Bunny Mod]    item: Fud
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: BaseballBat
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: Rock
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: Whiskey
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: Sword
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item: Beer
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item:
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item:
    [Message: Bunny Mod]    Loud: False
    [Message: Bunny Mod]    item:
    ...
    [Message: Bunny Mod]    item:
    [Message: Bunny Mod]    Loud: False
    [Info   : Unity Log] Out of Ammo
    ```
## All dialogue
- Not working. Status Text and Dialogue types haven't worked.
  - Attempted, with Afraid of Loud Noises. Three locations have cDialogue.CantUseLoud.
    - Accepted, distribute this method to all dialogue calls.
## DoubleTapper
- Hidden + unaware + distance
  - This is moved to Ghillie Suit
...
- Interiors (BasicFloor.Spawn)
  - Detect edge cases by chunk and/or floor type
    - Exclude rugs
    - Exclude graveyards
    - etc.
- Exteriors 
...
- Hostile cops don't act hostile
  - I think you need to set strikes
- Makes cops annoyed so you can't pay them off. 
  - Do you want to allow people with Priors to pay cops off? 
    - Just allow Pay Cop Debt through ATM at all times maybe?
## Reuse Base Methods
...
## Security Cams
- You know, you can force direction. Detect walls and force it. That's it. May need to bump north-facing ones half a square south though.
## Slot Machine
- Non-Jackpot
...
- Jackpot
  ...
  - InvItemCount is maxed at 128, you'll need to subdivide it
- Gate shutdown behind !NoLimitw
## Sniper
- Non-collision with hiddenIn object
  - Find bullet collision with object method, and except it if it's that object.
    - Moved to Ghillie Suit
      - Should probably just make part of Sniper or Sniper +
## Spelunky Dory
- Cave outcroppings
...
- Hide Offset adjustment
  - Plant
    - Accepted
  - Big Table 
    - Bounces out, currently to south. I think this one worked fine originally.
  - BathTub
...
## Underdark Citizen
- Take small damage if you walk into it instead of activating
- Slight cooldown between teleportation? Then again, toilets don't have it
...
- Freeze on level load:
    ```
    [Message: Bunny Mod] SpawnerMain_spawnObjectReal
    [Message: Bunny Mod]    objectType: Manhole
    [Message: Bunny Mod] UDManhole List count: 18
    [Message: Bunny Mod] StatusEffects_BecomeHidden
    [Message: Bunny Mod]    A0
    [Message: Bunny Mod]    B1
    [Message: Bunny Mod]    B2
    [Message: Bunny Mod]    A3
    [Message: Bunny Mod]    A4
    [Message: Bunny Mod]    A5
    [Message: Bunny Mod]    A6
    [Message: Bunny Mod]    A7
    [Message: Bunny Mod] StatusEffects_BecomeNotHidden_Prefix
    [Message: Bunny Mod]    A
    [Message: Bunny Mod]    A
    [Error  : Unity Log] NullReferenceException: Object reference not set to an instance of an object
    Stack trace:
    BunnyMod.Con    tent.BMAgents.StatusEffects_BecomeNotHidden_Prefix (StatusEffects __instance) (at <6ce14eaebc8e43abb3384b13c101d68b>:0)
    StatusEffects.BecomeNotHidden () (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
    BunnyMod.Content.BMAgents.StatusEffects_BecomeHidden (ObjectReal hiddenInObject, StatusEffects __instance) (at <6ce14eaebc8e43abb3384b13c101d68b>:0)
    StatusEffects.BecomeHidden (ObjectReal hiddenInObject) (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
    BunnyMod.Content.BMLevelGen+<LoadLevel_SetupMore3_3_Replacement>d__24.MoveNext () (at <6ce14eaebc8e43abb3384b13c101d68b>:0)
    BunnyMod.Content.BMLevelGen+<LoadLevel_SetupMore3_3_Postfix>d__25.MoveNext () (at <6ce14eaebc8e43abb3384b13c101d68b>:0)
...
- I think this is causing false bush moves
  - No, this was just visual. Accepted.
## Veiled Threats
- Go hostile if Annoyed
## Vendor Stand
- Stop Interaction after steal, name floated this time
