...
## Mob Debt
- Mobsters Annoyed from Level 1
- Mobsters Hostile from level 5
- Mobster hit squads after Level 10
...
- Model this one on Penetrating Bullets: BulletHitbox.HitObject
  - Attempted (If this doesn't work, try with eliminating BulletHitBox.OnTriggerEnter2d patch next)
