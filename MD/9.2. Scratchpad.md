...
- Affecting security item spawn chances
  ...
  - PFO.spawnChanceSpecial specifically refers to security items having variable spawns
    - Attempted
  - This one for some reason just wouldn't patch. Names and signatures look correct.

- Domineering
  - Lower both % chances to about 5
  - Domineering + 
    - Includes all allies in chunk
      - Use AgentInteractions.BecomeSubmissiveWithAlliesAllInChunk
- Double-Ply Rewards
  - Didn't work
- Eagle Eyes
...
- Panoptikopolis
  - When placing features, turn a Vending Machine into a Security Camera if it has any walls adjacent.
- Polarizing
  - No effect
- Polarizing + 
...
- Underdark Citizen
  - Make manholes generate in every district.
    - Try doing this where you enable boulders for the other one. It's possible there *are* no traits to detect while it's doing this.
