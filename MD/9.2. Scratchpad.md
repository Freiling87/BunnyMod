...
- Non-Numbered Reinforcements items:
...
- Overhauls
  ...
  - Just turn Ecology Arcology into an overhaul, or split its features off into one
    
- Mostly Automated Semi-Luxury Inclusive Terrestrial Socialism
...
- Underdark Citizen
  - Make manholes generate in every district.
    ...
    - Verify which feature generation script you're basing UD Manholes on. It didn't appear to be the vanilla Manhole used as a model in LoadLevel.
      - Please note that you put the vanilla generation in an "else" statement
