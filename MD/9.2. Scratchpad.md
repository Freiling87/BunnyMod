...
BunnyMod.Content.BMLevelGen+<LoadLevel_FillMapChunks_Replacement>d__28.MoveNext () (at <32699747e1cd43829e4d1a4b252c22ef>:0)
...
BunnyMod.Content.<LoadLevel_loadStuff2_Replacement>d__32:MoveNext()
UnityEngine.MonoBehaviour:StartCoroutine(IEnumerator)
LoadLevel:loadStuff()
...
- On load Park. Make sure you're checking for nulls, and doing it right.
```
...
Stack trace:
BunnyMod.Content.BMAgents.StatusEffects_BecomeHidden (ObjectReal hiddenInObject, StatusEffects __instance) (at <3eca1d0b4caa4ff3bd6a2550b0d1ddc7>:0)
StatusEffects.BecomeHidden (ObjectReal hiddenInObject) (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
BunnyMod.Content.BMLevelGen+<LoadLevel_SetupMore3_3_Prefix_Replacement>d__34.MoveNext () (at <3eca1d0b4caa4ff3bd6a2550b0d1ddc7>:0)
BunnyMod.Content.BMLevelGen+<LoadLevel_SetupMore3_3_Postfix>d__35.MoveNext () (at <3eca1d0b4caa4ff3bd6a2550b0d1ddc7>:0)
UnityEngine.SetupCoroutine.InvokeMoveNext (System.Collections.IEnumerator enumerator, System.IntPtr returnValueAddress) (at <73b499366e5241bda47e5da76897738b>:0)
```
...
---
## Bougie
- Doctors, IBs, Scientists friendly
- Poor & Dumb think you're an asshole
- Incompatible with "friendly with scum" traits
## DoubleTapper
- Directional requirements
- NPC unawareness requirements
...
## Fascist Lapdog
- All criminal & resistance are annoyed
- All LEOs are friendly
## Objects
- Post-Operating name hover.
  - This was previously resolved, how did it pop up again?
## Proletarian
- All working-class friendly
- Upper classes Annoyed
## Reinforcements(+)
  - Need a stat boost
    - Attempted
  - No longer defending self or player
## Slot Machine
- Works perfectly from the look of it, but button text does not match.
## Sniper
- It's doing Double-Tap.
## Spelunky Dory
- Cave outcroppings
