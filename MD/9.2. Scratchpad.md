...
## Arcology
- I think these two messages before the error are new, at least.
```
[Message: Bunny Mod] LoadLevel_CreateInitialMap
[Info   : Unity Log] LEVEL SIZE: 20
[Info   : Unity Log] Random Number After CreateInitialMap: 895
...
BunnyMod.Content.BMLevelGen+<LoadLevel_FillMapChunks_Replacement>d__27.MoveNext () (at <f2d762100f78492980360d55eb0b7e89>:0)
...
BunnyMod.Content.<LoadLevel_loadStuff2_Replacement>d__31:MoveNext()
UnityEngine.MonoBehaviour:StartCoroutine(IEnumerator)
LoadLevel:loadStuff()
