...
- Knock door
    ```
    [Message: Bunny Mod] Door_OpenDoor
    [Message: Bunny Mod]    Checkpoint 1
    [Message: Bunny Mod] Door_OpenDoorAnim
    [Warning: RogueLibs] SPECIAL RELEASE 0
    [Message: Bunny Mod] PlayfieldObject_FindDamage
    [Message: Bunny Mod]    Bullet hit
    [Message: Bunny Mod]    Distance: 1.018397
    [Message: Bunny Mod]    HasTrait: False
    [Message: Bunny Mod]    HasLOSObjectBehind: True
    [Message: Bunny Mod]    HasLOSAgent: False
    [Message: Bunny Mod]    HasDistance: False
    [Message: Bunny Mod]    Headshot: False
    [Info   : Unity Log] ADDRELHATE: Guard (1152) (Agent) - Playerr (Agent)
    ```
    - Had his back turned and could still see?
      - Not 100% sure of this, test it more.
## Eagle Eyes
...
## Slot Machine
- Jackpot animation
  - Check JukeboxPlayTime()
- SlotMachine drop cash:
  - See ObjectReal.DestroyMe2 line 72
- Jackpot should be pretty long if you bet $100.
  - Spit out little bits as you go, and spawn SDs to attack
  - Multiple messages:
    - Winner winner chicken dinner
    - Notice: Chicken Dinner not actually provided
## Sniper
