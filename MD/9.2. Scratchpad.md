...
- For SkillPoints_AddPoints: Get a string enum for all the basic XP types and their vanilla values
- Might want to increase trait options since we're adding so many more.
