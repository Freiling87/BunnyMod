...
- Jackpot
  ...
  - Check out the algorithm, something is off. Odds are much worse but payouts aren't higher. Hacking felt too effective compared to base game.
...
- Just make Ghillie Suit into Sniper +, since it's not intended for other uses.
## Spelunky Dory
- Cave outcroppings
