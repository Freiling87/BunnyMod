...
## ObjectReal
- Hacking now exits out when bar full
  - I think this is because ObjectReal is affected somewhere. I think it was where you put StopInteract() from the lemmi to the end of the code, but it shouldnt' be there for hack.
## Reinforcements(+)
  - Need a stat boost
    - Attempted
...
- Removed y-Offset
  - Apparently if the object is collideable, this will bounce you out. Maybe invert the y-Offset to bring the character to the front of the object instead, since the objects bias North?
