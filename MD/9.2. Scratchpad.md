...
```
[Info   : Unity Log] Loading Roamers
[Error  : Unity Log] ArgumentException: An item with the same key has already been added. Key: Hobo (2054) (Agent)
Stack trace:
System.Collections.Generic.Dictionary`2[TKey,TValue].TryInsert (TKey key, TValue value, System.Collections.Generic.InsertionBehavior behavior) (at <c79628fadf574d3a8feae0871fad28ef>:0)
System.Collections.Generic.Dictionary`2[TKey,TValue].Add (TKey key, TValue value) (at <c79628fadf574d3a8feae0871fad28ef>:0)
BunnyMod.Content.BMAgents.Agent_Start (Agent __instance) (at <ae47bfd7957943569145ee02d280cd22>:0)
Agent.Start () (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
Agent+<RecycleStart2>d__782.MoveNext () (at <5b00a25014d74f7f862ecdd1d48f7c04>:0)
...
- Interiors (BasicFloor.Spawn)
  - Basics are good, but notate any edge cases here.
