...
- Reenabled Casino ambience in mapgen. May break.
...
- Tethers
  - Gamecontroller.ChunkLeashPrefab
- spawnedAgent.losCheckAtIntervals
  - This is what makes Thieves want to pickpocket. Could be used for other stuff.
...
- Flammable Walls remove Fire Spewer
  - Attempted
- Leash mutators
  - Brainupdate.GoalArbitrate - search "20f", and that's your default chunk tether range.
- Panoptikopolis
  - Place cameras?
    - Custom Law Enforcement cameras that trigger anytime someone guilty is found
- Wall Mods
...
- General Relationship traits
  - Shows Annoyed, but don't act annoyed.
  - Might need to set strikes.
- Spawn traits
  - Not roaming level
...
- Mook Masher
  - Not moving, assume RLs aren't either
- Polarizing
  - No effect
- Polarizing + 
